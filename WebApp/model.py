...
def recomend(artist_name, state, city, radius, artist_genre1 = None):
...
Please enter WA, CA or OR  ''')
    ...
    result = recomender.get_best_fit_for_artist(city, state, radius,\
                                artist_genre = artist_genre, artist_bio = artist_bio)
    result = result[['venue_name','city','region']]
