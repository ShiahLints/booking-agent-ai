...
class Venue_Finder(object):
    ...
    def __init__(self, venues, citys_filepath = '../data/uscitiesv1.4.csv'):
        self.cities = pd.read_csv(citys_filepath)
        self.venues = venues
    ...
    def get_nearest_venues_by_city(self, city, state, milage=10):
        ...
        venues = self.find_at_least_100(lat, lng)
        return venues
    ...
    def find_at_least_n(self, lat, lng, n):
